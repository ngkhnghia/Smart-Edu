            ...
            Column(
              ...
              children: [
                Expanded(
                  child: Container(
                    padding: EdgeInsets.only(
                        left: 50 * widthR, top: 40 * heightR), //v26
                    child: Row(children: [
                      Icon(
                ...
                Expanded(
                  child: Container(
                    padding:
                        EdgeInsets.only(left: 75 * widthR, top: 14 * heightR),
                    child: Text(
        ...
        showDialog(
            ...
            builder: (context) {
              ...
              return AlertDialog(
                ...
                content: Text(
                    'LỖI: Dữ liệu thẻ ghi sai định dạng, vui lòng kiểm tra lại'),
              );
            });
      }
        ...
        showDialog(
            ...
            builder: (context) {
              ...
              return AlertDialog(
                ...
                content: Text(
                    'LỖI: Dữ liệu hexa ghi trong thẻ không hợp lệ, vui lòng kiểm tra lại'),
              );
            });
      }
            ...
            return Container(
              child: Column(
                ...
                children: [
                  Container(
                    padding: EdgeInsets.only(
                        top: 180 * heightR, right: 177 * heightR), //v26
                    child: Text(
                      'Xin chào!',
                      style: TextStyle(
...
class _NewMessageList extends State<MessageList> {
  //RemoteMessage mymess = RemoteMessage();
  RemoteNotification Noti = RemoteNotification();
  //List<RemoteMessage> mymess = [];
  double heightR = 0.0; //v26
